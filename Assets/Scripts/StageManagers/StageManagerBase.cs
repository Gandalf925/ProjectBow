...
public class StageManagerBase : MonoBehaviour
{
    ...
    private void SetWind()
    {
        if (stageData.isWindEnabled)
        {
            ...
            if (stageData.isRandomWindDirection)
            {
                windArea.RandomizeWindDirection();
            }
            else
            {
                windArea.SetWindDirection(stageData.windDirection);
            }

            if (stageData.isRandomWindStrength)
            {
                windArea.RandomizeWindStrength(stageData.maxWindStrength);
            }
            else
            {
                windArea.SetWindStrength(stageData.maxWindStrength);
            }
